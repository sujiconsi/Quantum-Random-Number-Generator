...
Obtained K₃ ≈ 1.4 > 1 --> clear **violation** of the classical Leggett–Garg bound, confirming quantum coherence.

### 4.5 NSIT @ t₂
<img width="668" height="495" alt="image" src="https://github.com/user-attachments/assets/0a308481-3ce9-48cb-9a7e-f2a84db6918c" />

Δ ≈ 0.53 shows measurement at t₁ influences t₂ --> evidence of temporal non-classicality.
...
The results confirm that even a small Hⁿ circuit produces **statistically fair and quantum-certified randomness**, applicable for secure cryptographic seeding, simulation, and educational research.
